<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePatientForm.aspx.cs" Inherits="MedicalManagement_Final.HomePatientForm" %>
...
body {
  ...
  background-image: url(https://images.unsplash.com/photo-1583830379747-195159d0de82?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTZ8fGhvc3BpdGFsfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60);
    color:whitesmoke;
}
  ...
  <div class="hamburger-icon">
   ...
   <link href="WeatherDivStyle.css" rel="stylesheet" />
          ...
          <ul class="menu-links">
            ...
            <li>
                <asp:Label Text="HERE 1" runat="server"></asp:Label>
            </li>
  ...
  <div class="body-text">
     ...
     <h2>
                  ...
                  <asp:Button ID="btnInbox" runat="server" OnClick="btnInbox_Click" Text="Inbox" />
                   <asp:Button ID="btnReqAppointment" runat="server" Text="Request Appointment" OnClick="btnReqAppointment_Click" />
     </h2>
      <br>
     <br>
          <h3>
               <asp:Button ID="btnExport" runat="server" Text="Export Appointments(Excel)" OnClick="btnExport_Click" />
                  <asp:Button ID="btnExportPers" runat="server" Text="Export Perscriptions(Excel)" OnClick="btnExportPers_Click" />
          </h3>
      <br>
     <br>

      <h4 style="margin:0 auto">
               <asp:Calendar ID="userCalender" runat="server" OnDayRender="Cal_DayRender"></asp:Calendar>
      </h4>
     ...
     <br>
      ...
      <h5>
              <asp:Label Text="List of Appointments" runat="server"></asp:Label>
              <asp:ListBox ID="lbAppointment" runat="server"></asp:ListBox>
      </h5>
     ...
     <br>
      ...
      <h6>
          <asp:Label Text="List of Perscriptions" runat="server"></asp:Label>
          <asp:ListBox ID="lboxPerscription" runat="server" Width="451px"></asp:ListBox>
      </h6>
        </div>
</div>
      </form>
