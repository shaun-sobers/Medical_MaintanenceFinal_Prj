<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestForm.aspx.cs" Inherits="MedicalManagement_Final.TestForm" %>
<!DOCTYPE html>
	...
	<div class="row input-container">
			...
			<div class="col-md-6 col-sm-12">
				<div class="styled-input">
                    <asp:TextBox ID="txtReasonfor" runat="server" placeholder="Reason For Consultation" CssClass="styled-input"></asp:TextBox>
				</div>
                <div>
                ...
                <div>
                     <asp:Label Text="Doctors Name" runat="server" CssClass="styled-input wide"></asp:Label>
                                            <asp:DropDownList ID="ddlDrsNames" runat="server">
                        </asp:DropDownList>
                </div>
                <div>
                 <asp:TextBox ID="txtExtraInfo" runat="server" CssClass="styled-input wide"></asp:TextBox>
                </div>
			</div>
			</div>
			<div class="col-xs-12">
